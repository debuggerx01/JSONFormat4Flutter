...
void main() {
  test('Test null', () {
    ...
    String str1 =
        '{"asd":[[[null,null]]],"qwe":[[[null]]],"qaz":[null,null,null]}';
    ...
    expect(ListsResp.parse(str6), null);
  });
  test('Test Region', () {
  ...
  test('test list top json', () {
    ...
    expect(resp.list.toString().replaceAll(' ', ''),
        json.encode(jsonRes).replaceAll('\n', '').replaceAll(' ', ''));
  });
  ...
  test('test list with string', () {
    ...
    expect(resp.toString().replaceAll(' ', ''),
        json.encode(jsonRes).replaceAll('\n', '').replaceAll(' ', ''));
  });
}
