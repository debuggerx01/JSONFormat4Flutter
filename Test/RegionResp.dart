...
class Arch {
  ...
  Arch.fromJson(jsonRes) {
    ...
    title = jsonRes['title'];
    tname = jsonRes['tname'];
    owner = jsonRes['owner'] == null ? null : Owner.fromJson(jsonRes['owner']);
    rights =
        jsonRes['rights'] == null ? null : Right.fromJson(jsonRes['rights']);
    stat = jsonRes['stat'] == null ? null : Stat.fromJson(jsonRes['stat']);
  }
